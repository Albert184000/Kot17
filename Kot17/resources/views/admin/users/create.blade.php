...
<head>
    <meta charset="UTF-8">
    <title>បន្ថែមអ្នកប្រើប្រាស់ថ្មី - កុដិ១៧</title>
...
<div class="col-md-6">
    ...
    <div class="input-group custom-input-group">
        ...
        <select name="role" class="form-select" required>
            ...
            <option value="treasurer" {{ old('role') === 'treasurer' ? 'selected' : '' }}>
                Treasurer
            </option>
            ...
            <option value="utility" {{ old('role') === 'utility' ? 'selected' : '' }}>
                Utility (ទឹក / ភ្លើង)
            </option>
        </select>
    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group custom-input-group">
                                    ...
                                    <select name="person_type" class="form-select" id="personType">
                            ...
                            {{-- Dynamic Monk Fields (Only ONE set here) --}}
                            <div class="col-md-6 monk-only d-none">
                                ...
                                <div class="input-group custom-input-group">
                                    ...
                                    <select name="monk_rank" class="form-select @error('monk_rank') is-invalid @enderror" id="monkRank">
                                        ...
                                        <option value="senior_monk" {{ old('monk_rank')==='senior_monk'?'selected':'' }}>ព្រះភិក្ខុ</option>
                                        <option value="monk" {{ old('monk_rank')==='monk'?'selected':'' }}>សាមណេរ</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 monk-only d-none">
                                ...
                                <div class="input-group custom-input-group">
                                    ...
                                    <input type="number" name="vassa" class="form-control @error('vassa') is-invalid @enderror" placeholder="0" value="{{ old('vassa') }}">
                                </div>
                            </div>
...
<script>
    // Unified Script for Avatar and Toggle Logic
    (() => {
        // 1. Toggle Monk Fields Logic
        ...
        function toggleMonkFields() {
            ...
            monkOnlyFields.forEach(el => {
                if (isMonk) el.classList.remove('d-none');
                    ...
                    if (input) input.value = ''; // Clear values if not monk
                }
            });
        }
